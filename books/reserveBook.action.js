...
async function reserveBook(userId, bookId, returnDate) {
  ...
  // Validar que returnDate no sea menor a la fecha de reserva
  if (returnDate && new Date(returnDate) < reservationDate) {
    throw new Error("Return date cannot be earlier than reservation date");
  }
